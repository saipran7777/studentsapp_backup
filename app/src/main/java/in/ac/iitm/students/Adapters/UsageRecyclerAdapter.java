...
import in.ac.iitm.students.MyApplication;
import in.ac.iitm.students.NetaccessActivity;
    ...
    private void Revoke(String link) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, requestURL1,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("userPassword", NetaccessActivity.getprefString("ldap", MyApplication.getContext()));
                params.put("userLogin", NetaccessActivity.getprefString("rollno", MyApplication.getContext()));
                return params;
            }
        };
